...
try:
    ...
    build_dir = r"C:\Users\narom\Documents\AllProjects\LearnCppGameEngine\LightYears\build"
    os.makedirs(build_dir, exist_ok=True)

    # Create the boilerplate_stamp file in the build directory
    stamp_path = os.path.join(build_dir, "boilerplate_stamp")
    with open(stamp_path, "w") as stamp_file:
        stamp_file.write("Stamp file created.")
    print(f"Stamp file created at {stamp_path}")
